...
public class TimeConverter extends AbstractTypeConverter<Long> {
     ...
     *
     * <p>THIS CLASS: THREE branches - {@code LocalTime.parse}, a {@code "H:mm"} formatter and
     * {@code Long.parseLong} - and NONE of them consults config. The shared wording this
     * replaces claimed five-or-three branches "two of which consult config", which was wrong
     * here in both halves.</p>
     *
